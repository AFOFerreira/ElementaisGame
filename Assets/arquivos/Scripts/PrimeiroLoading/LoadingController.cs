...
public class LoadingController : MonoBehaviour
{
    ...
    private async void Start()
    {
        ...
        //}
        //status.text = "Consultando ancestrais...";
        await AnimMensagem("Consultando ancestrais...");
        await Task.Delay(2000);
        //status.text = "Preparando elementais...";
        await AnimMensagem("Preparando elementais...");
        carAgua.fillAmount = 1;
        await Task.Delay(3000);
        //informa que vai comecar a carregar a cena.
        //status.text = "Carregando cena";
        await AnimMensagem("Carregando cena");
        await Task.Delay(1000);
        //inicia o loading.
        StartCoroutine(LoadingScreen(1));
    }

    IEnumerator AnimMensagem(string msg)
    {
        status.text = "";
        float tempo = 0.05f;
